...
- Execute T4.4/T4.4a to refresh loop failure handling and snapshot wiring once DTO parity work lands. *(Console/loop snapshot path already uses runtime snapshots; remaining cleanup focuses on failure telemetry wiring and documentation.)*
