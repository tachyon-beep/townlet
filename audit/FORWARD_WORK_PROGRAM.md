...
- **Fix / Change**: Locked the narrative storyline (`demo_story_arc`) behind hashed assets (config `a57bea3dea6d755498af260e39cb7876dc068ee2`, timeline `dafe8f3298f62e1ddeaf0fd40c7907fc3507b2d6`), published an operator playbook (`docs/ops/DEMO_SCENARIO_PLAYBOOK.md`), wired rehearsal automation (`scripts/demo_rehearsal.sh`), and expanded narrative tests (state mutation + golden narration fixture).
